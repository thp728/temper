...
// it always was, at the moment a run is launched. The header anatomy matches
// the other list pages (breadcrumb + title + subtitle) so it sits identically.
export default function ModelsPage() {
  return (
    <section aria-labelledby="models-heading" className="space-y-8">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
      ...
      <div className="space-y-1">
        <h1 id="models-heading" className="text-2xl font-semibold tracking-tight text-balance">
          Models
        </h1>
