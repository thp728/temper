...
The vault's `decisions.md` held the first thirteen decisions and is closed to new entries. They are
copied into `docs/adr/` as [0013]–[0025] (issue #26); new decisions land here only.
