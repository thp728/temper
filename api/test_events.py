...
from api.events import classify
...
def test_a_training_log_line_yields_loss_and_epoch():
    line = ("{'loss': 1.9042, 'grad_norm': 3.9971, "
...
def test_a_progress_bar_is_not_a_training_step():
    ...
    assert is_log("Map:  45%|████▌     | 90/200 [00:01<00:01, 88.0 examples/s]")
    assert is_log("model.safetensors:  10%|█         | 400M/4.00G [00:05<00:45]")
