...
from api import hyperparams  # noqa: E402
...
def test_alpha_tracks_rank_when_only_rank_is_moved():
    ...
    assert eff["lora_alpha"] == 128, "a new rank must not pair with a stale scale"
...
def test_locked_settings_ignore_overrides():
    ...
    eff = hyperparams.effective({"warmup_ratio": 0.9, "lr_scheduler": "constant"})
